...
Đã sửa:
1) Trang /admin.html#settings có nút LƯU riêng cho SePay.
2) Trang /admin.html#settings có nút LƯU riêng cho SMTP.
...
- ADMIN_SETTINGS_PASSWORD: mật khẩu vào trang /admin.html#settings
