...
const BANK_BIN = { ACB:'970416', VCB:'970436', VIETCOMBANK:'970436', TECHCOMBANK:'970407', TCB:'970407', MB:'970422', MBBANK:'970422', BIDV:'970418', VIETINBANK:'970415', CTG:'970415' };
...
export function normalizeSettings(input={}){
  ...
  for (const id of ['3m','6m','12m']) {
    ...
    plans[id] = { id, name: str(x.name, DEFAULT_SETTINGS.payment.plans[id].name).toUpperCase(), amount: Number(x.amount || DEFAULT_SETTINGS.payment.plans[id].amount), days: Number(x.days || DEFAULT_SETTINGS.payment.plans[id].days), enabled: x.enabled !== false };
  }
  return {
    payment: {
