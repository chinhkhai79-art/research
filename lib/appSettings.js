...
function normalizeAccount(source={}){
  ...
  return {
    ...
    trialHours,
    trialLabel,
    trialYoutubeApiKey: str(rawTrial.trialYoutubeApiKey || rawTrial.youtubeApiKey || rawTrial.youtubeApiKeyV3 || rawTrial.ytApiKey || ''),
    trialGeminiApiKey: str(rawTrial.trialGeminiApiKey || rawTrial.geminiApiKey || rawTrial.geminiKey || '')
  };
}
...
export async function saveAppSettings(input={}){
  ...
  if (Object.prototype.hasOwnProperty.call(input?.account || {}, 'trialYoutubeApiKey')) {
    merged.account = { ...(merged.account || {}), trialYoutubeApiKey: String(input.account.trialYoutubeApiKey || '').trim() };
  }
  if (Object.prototype.hasOwnProperty.call(input?.account || {}, 'trialGeminiApiKey')) {
    merged.account = { ...(merged.account || {}), trialGeminiApiKey: String(input.account.trialGeminiApiKey || '').trim() };
  }
